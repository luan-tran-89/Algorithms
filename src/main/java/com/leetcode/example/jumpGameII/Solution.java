package com.leetcode.example.jumpGameII;
 ...
 * 0 <= j <= nums[i] and
 * i + j < n
 * Return the minimum number of jumps to reach nums[n - 1]. The com.test cases are generated such that you can reach nums[n - 1].
 *
 * Example 1:
